---
title: Use OpenAgent in Obsidian
---
...
- [OpenAgent User Guide](./getting-started/user-guide.md#workspace)
...
- [OpenAgent User Guide](./getting-started/user-guide.md#canvas-selection)
